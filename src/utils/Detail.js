  ...
  return (
    <div data-testid="Details-1" className="flex flex-col gap-2 justify-start items-between mt-10 [&>*:nth-child(2n+3)]:bg-violet-900/20 border border-black/10">
      ...
      <div className="flex justify-between px-4 py-4">
        ...
        <span>
          {details.priceChange1w < 0 ? <span>{details.priceChange1w}</span> : <span>{details.priceChange1w}</span>}
          <i className="fa-solid fa-circle-arrow-right pl-2" />
        </span>
      </div>
      <div className="flex justify-between px-4 py-4">
        ...
        <span>
          {details.priceChange1d < 0 ? <span>{details.priceChange1d}</span> : <span>{details.priceChange1d}</span>}
          <i className="fa-solid fa-circle-arrow-right pl-2" />
        </span>
      </div>
      <div className="flex justify-between px-4 py-4">
        ...
        <span>
          {details.priceChange1h < 0 ? <span>{details.priceChange1h}</span> : <span>{details.priceChange1h}</span>}
          <i className="fa-solid fa-circle-arrow-right pl-2" />
        </span>
      </div>
    </div>
